        ...
        <div className="flex border-b border-gray-200 dark:border-gray-800 gap-6 pb-px">
          {['experience', 'strengths'].map((tab) => (
            <button
              ...
              className={`pb-4 text-lg font-bold font-display uppercase tracking-wider relative transition-colors duration-300 ${
                activeTab === tab ? 'text-accent-teal' : 'text-text-muted hover:text-text-main'
              }`}
            >
