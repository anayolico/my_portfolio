        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 pt-32 pb-24 w-full flex-grow space-y-12">
          ...
          {loading ? (
            ...
            <div className="glass-card p-12 rounded-3xl text-center max-w-md mx-auto space-y-3 border border-accent-teal/20">
              ...
              <h3 className="text-lg font-bold text-text-main font-display">No Codebases Found</h3>
              <p className="text-xs text-text-muted leading-relaxed">
                No source code packages matched your search criteria. Check back soon for new releases!
              </p>
            </div>
          )}
        </main>
