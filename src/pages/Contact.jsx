        ...
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-3xl mx-auto">
            ...
            <motion.a
              ...
              href="https://instagram.com/caleb_anayolico" target="_blank" rel="noopener noreferrer"
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-text-muted">@caleb_anayolico</p>
                </div>
              </div>
            ...
            <motion.a
              whileHover={{ y: -4, scale: 1.02 }}
              href="https://youtube.com/@caleb_anayolico" target="_blank" rel="noopener noreferrer"
